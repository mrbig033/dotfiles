...
alias ggs='clear && exec "$BASH"'
alias ss='clear && exec "$BASH"'
alias gs='clear && exec "$BASH"'
...
alias jj='jmacs'
alias tt='nvim ~/Documents/Testing/loremipsum'
...
alias db='i3-msg "[title=term-up]" move scratchpad && emacs --debug-init &>/dev/null &'
