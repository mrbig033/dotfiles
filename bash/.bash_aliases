...
# alias p='python /home/jerry/Studying/Prog/Python/code/scratch.py'
alias p='python'
...
alias ag='sudo ag'
alias bb='bat'
alias gpart='~/scripts/cline_scripts/gparted'
alias vi='vim.tiny'
...
alias na='nvim *'
alias h1='e /media/jerry/h1'
alias h2='e /media/jerry/h2'
alias bp='clear && bpython'
alias tee='cd ~/.texpander && nvim ./*'
alias o='cd /home/jerry/Python/code/basics/loops && cc'
alias ps='~/Studying/Prog/Python/code/scratch.py'
