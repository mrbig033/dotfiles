...
bindsym $mod+Shift+F10 exec "~/maps/suckless/st_bin3/bin/st -t term-ranger2 -n term-ranger2"
...
**** Term Ranger2
#+BEGIN_SRC i3
for_window [class="term-ranger2" title="term-ranger2"] border none
for_window [class="term-ranger2" title="term-ranger2"] floating enable sticky enable
for_window [class="term-ranger2" title="term-ranger2"] move scratchpad
for_window [class="term-ranger2" title="term-ranger2"] resize set 1250 450; move to position 350 0
