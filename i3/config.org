...
bindsym XF86AudioRaiseVolume exec "pactl set-sink-mute 0 false; pactl set-sink-volume 0 +25%"
bindsym XF86AudioLowerVolume exec "pactl set-sink-mute 0 false; pactl set-sink-volume 0 -25%"
#+END_SRC
* Windows
** Floating Disable
#+BEGIN_SRC i3
