...
bindsym $mod+Shift+F8 exec "st -T term-up"
...
** Media Keys
#+BEGIN_SRC i3
bindsym XF86AudioPlay exec playerctl play-pause; exec "notify-send --expire-time=1000 'play/play'"
bindsym XF86AudioMute exec "pactl set-sink-mute 0 toggle; "exec "notify-send --expire-time=1000 'mute/unmute'"
bindsym XF86AudioRaiseVolume exec "pactl set-sink-mute 0 false; pactl set-sink-volume 0 +25%"; exec "notify-send --expire-time=1000 'vol +25%'"
bindsym XF86AudioLowerVolume exec "pactl set-sink-mute 0 false; pactl set-sink-volume 0 -25%"; exec "notify-send --expire-time=1000 'vol -25%'"
#+END_SRC
* Windows
** Floating Disable
#+BEGIN_SRC i3
