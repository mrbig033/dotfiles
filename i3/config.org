...
exec --no-startup-id "~/scripts/cline_scripts/sessions.sh && xfce4-terminal --command='tmux attach' --working-directory=~ --title=term-up --hold &"
...
** general
#+BEGIN_SRC i3
bindsym $mod+Shift+u [title="term-up"] kill; exec "~/scripts/cline_scripts/sessions.sh &>/dev/null &"
...
bindsym F10 exec "~/maps/texpander/texpander.sh"; mode default
bindsym w exec "st -e ~/.pyenv/shims/bpython --quiet"; mode default
