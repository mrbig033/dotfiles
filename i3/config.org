...
** general
#+BEGIN_SRC i3
bindsym F9 exec "xfce4-terminal --command='tmux attach' --working-directory=~ --title=term-up --hold &"
# bindsym F10 exec "xfce4-terminal --title=term-ranger --command='ranger'"
bindsym F10 exec "st -T term-ranger"
