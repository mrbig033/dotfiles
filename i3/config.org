...
** general
#+BEGIN_SRC i3
bindsym $mod+Shift+F9 exec "xfce4-terminal --command='tmux attach' --working-directory=~ --title=term-up --hold"
bindsym $mod+Shift+F10 exec "xfce4-terminal --working-directory=~ --title=term-ranger --hold"
bindsym $mod+Shift+F11 exec "~/maps/suckless/st_bin3/bin/st -t term-ranger2 -n term-ranger2 -e ranger"
