...
** general
#+BEGIN_SRC i3
bindsym $mod+Shift+u [title="term-up"] kill; exec "~/scripts/i3_scripts/term-up"
...
bindsym $mod+o [title="term-up"] move scratchpad; [title="mrblack"] scratchpad show; move to position 350 0
#+END_SRC
** Small
# *** General
# #+BEGIN_SRC i3
