...
exec --no-startup-id "xfce4-terminal --working-directory=/home/jerry/Python/code --title=term-bpython --hold &"
...
** general
#+BEGIN_SRC i3
bindsym F9 [title="term-up"] kill; exec "/home/jerry/dotfiles/scripts/cline_scripts/sessions.sh"; exec "sleep 2"; exec "xfce4-terminal --command='tmux attach' --working-directory=~ --title=term-up --hold &"
# bindsym $mod+Shift+u [title="term-up"] kill; [title="term-up"] scratchpad show

bindsym $mod+Shift+p exec "xfce4-terminal --working-directory=/home/jerry/Python/code --title=term-bpython --hold &"
bindsym $mod+Shift+r [title="term-ranger"] kill; exec "/home/jerry/scripts/i3_scripts/term-ranger"
